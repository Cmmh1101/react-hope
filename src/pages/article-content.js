...
Thank you and I will be back soon with my week 3 into nucamp!.
See you later!
`,
    ],
  },
  {
    ...
    content: [
      ...
      `2. You will have a mix of self-learning and instruction`,
      `3. Your instructors will guide you and help if needed`,
      `4. Group experience`,
      `5. Accountability`,
      `6. Price and time flexibility`,
      ...
      `Nucamp site: https://www.nucamp.co.
            Code: 4MQLEG (Using this code will not cost you anything, but it will help in supporting my journey)`,
    ],
  },
  {
    ...
    content: [
      ...
      `I have been always attracted to tech, I took a web dev class while in school but it was something really basic and I can't even remember what we use at that time, the only thing I can remember is the feeling of building and seeing something work on the browser (we didn't get to learn how to deploy at all).
            I know I enjoyed it but again I was working towards my teaching career and I thought that the web was something exclusive for those with a Computer Science degree like my brother was at that moment. So, I leave that alone in the past.`,
      ...
      `Then, I wanted to complement my knowledge and learned WordPress so I could help my friend. I complete that course as well and great. Now, the question again... What's next? 
       After a while tumbling between web design, WordPress, and Web Development... Something happened, I discovered something absolutely NEW to me. I found podcasts talking about people who were self-taught web developers and got extreme career changes from different fields without a degree. `,
      `I recovered that feeling of excitement and that was the best thing that could happen. I loved it and reinforce things learned previously, it was a simple HTML & CSS course. But, how powerful when it showed how to deploy a site, MIND-BLOWING! `,
      `What? Really? It was hard to believe but the more I looked for the more people I found and got me thinking, analyzing things, setting new goals and challenges, by the way until this point I was on my own with no support or accountability from anyone else in the same journey that I was getting into so that was the missing part (if you haven’t joined communities please DO IT now). 
       Then, once I was starting to take it more seriously and having the hope given by others, my sister who is overseas started to ask me hey, how is this going I need to change my career and explore if this is for me. So I shared the podcasts I was listening to as well as FreeCodeCamp and started having that accountability partner that I was also missing. `,
